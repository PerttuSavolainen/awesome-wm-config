...
local autostart_processes = {
    "unclutter -root",
    "xrdb ~/.Xresources",
}

run_once(autostart_processes)
-- }}}
...
local editor       = os.getenv("EDITOR") or "code-oss"
local gui_editor   = "code-oss"
local browser      = "chromium-browser"
local guieditor    = "code-oss"
...
screen.connect_signal("arrange", function (s)
    -- Add rounded corners to all clients in a screen
    for _, c in pairs(s.clients) do
        gears.surface.apply_shape_bounding(c, gears.shape.rounded_rect, 2)        
    end
end)
