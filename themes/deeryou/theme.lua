...
local personal_settings = {
    open_weather_map_city_id = 655195, -- Jyväskylä, Finland
}

local theme                                     = {}
theme.confdir                                   = os.getenv("HOME") .. "/.config/awesome/themes/deeryou"
theme.wallpaper                                 = theme.confdir .. "/deer.jpg"
theme.font                                      = "DejaVu Sans Mono 11"
theme.menu_bg_normal                            = "#371232EF"
theme.menu_bg_focus                             = "#371232EF"
theme.bg_normal                                 = "#371232EF"
theme.bg_focus                                  = "#371232EF"
theme.bg_urgent                                 = "#371232EF"
theme.fg_normal                                 = "#aaaaaa"
theme.fg_focus                                  = "#ff8c00"
theme.fg_urgent                                 = "#af1d18"
theme.fg_minimize                               = "#ffffff"
theme.border_width                              = 0
theme.border_normal                             = "#522152EF"
theme.border_focus                              = "#522152EF"
theme.border_marked                             = "#522152EF"
...
theme.weather = lain.widget.weather({
    city_id = personal_settings.open_weather_map_city_id,
    units = "metric",
...
-- CPU temperature
local cputempicon = wibox.widget.imagebox(theme.widget_temp)
...
function theme.at_screen_connect(s)
    ...
    gears.wallpaper.maximized(wallpaper, s, false, { y = -1600 })
